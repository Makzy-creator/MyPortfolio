  ...
  return (
    <header id='h-hero' className='h-hero flex'>
      <div className="h-content">
        ...
        <div className='flex'>
              <h1 className=' [letter-spacing:2px] font-semibold text-2xl'>And I'm </h1>
              <FloatWriter/>
        </div>
        <p className='font-medium'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. <span className=' text-white'>Fugiat, itaque placeat dicta accusamus illum maxime voluptas illo nesciunt deleniti
          </span></p>
